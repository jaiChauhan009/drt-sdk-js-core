...
describe("test address", () => {
    ...
    it("should throw error when invalid input", () => {
        ...
        assert.throw(
            () => new Address("xdrt1l453hd0gt5gzdp7czpuall8ggt2dcv5zwmfdf3sd3lguxseux2fsmsgldz"),
            errors.ErrAddressCannotCreate,
        );
    });
    ...
    it("should validate the address without throwing the error", () => {
        ...
        assert.isFalse(Address.isValid("xdrt1l453hd0gt5gzdp7czpuall8ggt2dcv5zwmfdf3sd3lguxseux2fsmsgldz"));
    ...
    it("should check whether isSmartContract", () => {
        ...
        assert.isTrue(
            Address.fromBech32("drt1qqqqqqqqqqqqqqqpqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqplllskzf8kp").isSmartContract(),
        );
        assert.isTrue(

...
describe("test delegation transactions factory", function () {
    ...
    it("should create 'Transaction' for adding nodes", async function () {
        const sender = Address.fromBech32("drt18s6a06ktr2v6fgxv4ffhauxvptssnaqlds45qgsrucemlwc8rawqfgxqg5");
        const delegationContract = Address.fromBech32("drt1qqqqqqqqqqqqqqqpqqqqqqqqqqqqqqqqqqqqqqqqqqqqqtlllllsjnaptx");
        ...
        assert.equal(transaction.sender, "drt18s6a06ktr2v6fgxv4ffhauxvptssnaqlds45qgsrucemlwc8rawqfgxqg5");
        assert.equal(transaction.receiver, "drt1qqqqqqqqqqqqqqqpqqqqqqqqqqqqqqqqqqqqqqqqqqqqqtlllllsjnaptx");
        assert.isDefined(transaction.data);
        assert.deepEqual(
            transaction.data,
            Buffer.from(
